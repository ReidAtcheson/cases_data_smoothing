...
cases=np.array(df["US"].values,dtype=np.float64)
...
plt.savefig("united_states_raw.svg")
plt.close()
...
plt.savefig("united_states_smoothed.svg")
plt.close()
...
plt.savefig("united_states_moving_average.svg")
